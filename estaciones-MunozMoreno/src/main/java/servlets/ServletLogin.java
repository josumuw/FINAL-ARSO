...
import citybike.modelo.Usuario;
...
public class ServletLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (identificado) {
			...
			// Redirigir a la página inicio.xhtml después de 2 segundos
		    out.println("<script>");
		    out.println("setTimeout(function(){ window.location.href='" + request.getContextPath() + "/inicio.xhtml'; }, 10);");
		    out.println("</script>");
